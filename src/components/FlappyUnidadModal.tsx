...
import { Trophy, RotateCcw, X, Play, Volume2, VolumeX, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-3xl overflow-hidden max-w-sm w-full shadow-2xl border border-emerald-500/30 flex flex-col items-center relative">
        ...
        {/* Header Bar */}
        <div className="w-full bg-[#008037] text-white p-4 flex items-center justify-between border-b border-emerald-600">
          <div className="flex items-center gap-2">
            <UnidadVeterinariaEmblem className="w-7 h-7 shrink-0" />
            <div>
              <h2 className="text-sm font-black tracking-tight flex items-center gap-1.5 font-serif">
                Flappy Unidad <Sparkles className="w-3.5 h-3.5 text-amber-300" />
              </h2>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              {isMuted ? <VolumeX className="w-4 h-4 text-rose-200" /> : <Volume2 className="w-4 h-4 text-emerald-200" />}
            </button>
        ...
        <div className="w-full bg-emerald-50 px-3.5 py-2.5 flex items-center justify-between text-xs font-bold text-emerald-950 border-b border-emerald-200/60">
        ...
        >
          ...
          {/* Overlay: IDLE State */}
          {gameState === 'IDLE' && (
            <div className="absolute inset-0 bg-black/50 backdrop-blur-2xs flex flex-col items-center justify-center text-center p-5 text-white space-y-3.5">
              <div className="w-14 h-14 rounded-full bg-white/20 p-2 backdrop-blur-md border border-white/30 animate-bounce">
              ...
              <div>
                ...
                <p className="text-xs text-emerald-100 mt-0.5 max-w-[220px]">
                  Toca la pantalla o presiona <strong>Espacio</strong> para esquivar tuberías.
                </p>
              </div>
              ...
              <div
                ...
                className="bg-black/40 backdrop-blur-md p-2 rounded-2xl border border-white/20 w-full max-w-[310px] space-y-1.5"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-[#008037] text-white font-extrabold text-sm shadow-lg hover:bg-emerald-600 active:scale-95 transition-all border border-emerald-400/30"
              >
          ...
          {gameState === 'GAMEOVER' && (
            <div className="absolute inset-0 bg-black/65 backdrop-blur-xs flex flex-col items-center justify-center text-center p-5 text-white space-y-3 animate-in zoom-in-95 duration-150">
              <div className="bg-white text-slate-900 rounded-3xl p-5 w-full max-w-[300px] shadow-2xl border border-slate-200 space-y-3">
                <span className="text-xs font-extrabold uppercase text-rose-600 tracking-wider">
                  ¡Game Over!
                </span>

                <div className="py-1 space-y-0.5">
                  <p className="text-3xl font-black font-mono text-[#008037]">
                ...
                >
                  <span className="text-[10px] font-bold text-slate-500 uppercase tracking-wide">Cambiar Dificultad</span>
                ...
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-2xl bg-[#008037] text-white font-extrabold text-xs shadow-md hover:bg-emerald-600 transition-all active:scale-95"
                >
                  <RotateCcw className="w-4 h-4" />
                  Reintentar ({currentConfig.name})
                </button>
              </div>
            </div>
          )}
        ...
        <div className="w-full bg-slate-100 p-3 text-center text-[11px] text-slate-500 font-medium border-t border-slate-200">
